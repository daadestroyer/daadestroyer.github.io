function init(){
   	alert('Open this game in PC/Laptop');
        alert('Use upward,downward,left,right Arrow Keys');
	alert('Ready to play game');
	...
	snake = {
		...
		drawSnake:function(){
			...
			for(var i=0;i<this.cells.length;i++){
                ...
                pen.fillText("Snake Game", 750, 50)
                pen.font="30px Georgia";
                pen.fillText("Made by - daadestroyer", 1420, 850);
...
function draw(){
	...
	pen.fillText(person+' Your score is : '+score, 20, 50)
...
function gameloop(){
	if(game_over==true){
		clearInterval(f);
		alert("Game Over");
		alert('Hey '+person+' you played well your score is : '+score)
